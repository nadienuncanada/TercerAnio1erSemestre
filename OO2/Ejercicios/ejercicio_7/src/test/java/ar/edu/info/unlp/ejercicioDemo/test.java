...
class test {
	...
	void testArchivoMasGrande() {
		assertEquals(archA123, dirA1.achivoMasGrande());
		assertEquals(null, dirB.achivoMasGrande());
	}
	
	@Test
	void testArchivoMasNuevo() {
		assertEquals(archA123.getFechaCreacion(), dirA1.archivoMasNuevo().getFechaCreacion());
